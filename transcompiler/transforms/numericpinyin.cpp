...
TonumericPinyinFunctionType generatePipeline(CPUDriver & pxDriver) {
    ...
    re::CC* ccTest = dyn_cast<re::CC>(UCD::externalizeProperties(UCD::linkAndResolve(re::simplifyRE(re::RE_Parser::parse("ello\nThere", re::ModeFlagType::CASE_INSENSITIVE_MODE_FLAG, re::RE_Syntax::FixedStrings)))));
