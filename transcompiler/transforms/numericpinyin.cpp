...
TonumericPinyinFunctionType generatePipeline(CPUDriver & pxDriver) {
    ...
    re::CC* ccTest = dyn_cast<re::CC>(UCD::externalizeProperties(UCD::linkAndResolve(re::simplifyRE(re::RE_Parser::parse("[There]", re::ModeFlagType::CASE_INSENSITIVE_MODE_FLAG)))));
