...
ToHalfFullFunctionType generatePipeline(CPUDriver & pxDriver) {
    ...
    doHalfFullTransform(P, U21, finalBasis);
    ...
    return reinterpret_cast<ToHalfFullFunctionType>(P->compile());
}
...
int main(int argc, char *argv[]) {
    ...
    CPUDriver driver("tohalfFull");

    //  Build and compile the Parabix pipeline by calling the Pipeline function above.
    ToHalfFullFunctionType fn = generatePipeline(driver);
