...
static cl::opt<size_t, true> optNumOfSteps("steps",  cl::init(4), cl::location(NumOfSteps),
...
static cl::opt<size_t, true> optNumOfHashBits("hashsize",  cl::init(30), cl::location(NumOfHashBits),
                                      cl::desc("number of hash bits generated by the hashing function (default=30)"),
                                      cl::value_desc("positive integer"), cl::cat(hashFlags));

size_t NumOfHashTrieLevels = 0;

static cl::opt<size_t, true> optNumOfHashTrieLevels("hashtrielevels",  cl::init(6),cl::location(NumOfHashTrieLevels),
